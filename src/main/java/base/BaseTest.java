...
public class BaseTest {
	...
	public BaseTest() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("E:\\Work\\HRM\\src\\main\\java\\configproperties\\config.properties");
			prop.load(ip);
	...
	public void intialization() {
		...
		if (browsername.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "E:\\Work\\HRM\\chromedriver.exe");
